...
{
    if(Alojamientos.hoteles.hotel[i].nombre.toLowerCase()==hotelP.toLowerCase()) break;
...
for (let i = 0; i < asservicios.length; i++) {
  ...
  cadena += `<img id="`+asservicios[i].trim()+`" class="icono" src="assets/`+serviciosIMG.get(asservicios[i].trim())+`" width="20px" height="20px"
